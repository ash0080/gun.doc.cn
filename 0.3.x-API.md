...
Load all data under that [key](#gunkeyname) into the context, and saving it to local persistence.
...
## Name
The [`keyName`](#gunkeyname) string is the name of the group you want to get. If gun can't find the key, it's implicitly initialized as an empty object.
