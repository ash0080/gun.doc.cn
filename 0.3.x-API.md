...
**Table of Contents**
 - [Gun constructor](https://github.com/amark/gun/wiki/0.3.x-API#gunoptions)
 - [gun.put](https://github.com/amark/gun/wiki/0.3.x-API#gunputdata-callback)
   - [accepted values](https://github.com/amark/gun/wiki/0.3.x-API#allowed-types)
   - [callback](https://github.com/amark/gun/wiki/0.3.x-API#callbackerror-success)
   - [examples](https://github.com/amark/gun/wiki/0.3.x-API#examples-1)
   - [chain](https://github.com/amark/gun/wiki/0.3.x-API#chain-context)
 - [gun.get](gungetkey)
